defmodule DotuhWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :dotuh
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :dotuh
  end
